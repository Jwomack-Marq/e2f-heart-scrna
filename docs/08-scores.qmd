...
Two panels under **Scores & overlaps**. Both scores are cardiomyocyte-specific, so they
sit on the cardiomyocyte side rather than with the all-cell-type views — but they are
*derived* quantities rather than a view of the compartment itself, which is why they are one
menu over from the deep-dive. **Cell-cycle exit & ploidy** shows four module-score
