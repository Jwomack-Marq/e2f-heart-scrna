...
Two panels, one menu apart. **Maturation & metabolism** sits under **Scores & overlaps**;
**Cell-cycle exit & ploidy** sits under **Cell cycle**, alongside the tricycle projection in
[chapter 12](12-cellcycle.qmd), because the two answer the same question from opposite ends —
one scores curated exit and ploidy gene sets, the other measures position on the cycle
directly. Both scores are cardiomyocyte-specific, so they sit on the cardiomyocyte side
rather than with the all-cell-type views, and both are *derived* quantities rather than a
view of the compartment itself. **Cell-cycle exit & ploidy** shows four module-score
