...
1. **A conditional allele a 3′-biased assay cannot see.** If the targeting removes an
   internal exon or inserts a cassette upstream of the 3′ end, reads from a 3′-biased
   assay pile up in the final exon and count the transcript as present. PIP-seq is
   3′-biased, so this explanation survives the platform correction unchanged. The protein can be absent while the
